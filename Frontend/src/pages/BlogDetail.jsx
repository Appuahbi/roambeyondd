...
export default function BlogDetail() {
  ...
  if (!blog) return (
    <div className="section py-20 text-center">
      ...
      <Link to="/blogs" className="btn-primary mt-5 inline-flex">Back to blogs</Link>
    </div>
  );
      ...
      <header className="bg-cream-gradient pt-10 pb-6">
        <div className="section">
          <nav className="breadcrumb">
            ...
            <Link to="/blogs">Blogs</Link> <ChevronRight size={12} />
          ...
          <div className="mt-4 max-w-3xl">
            ...
            <p className="mt-3 text-ink-500 text-sm inline-flex items-center gap-3">
              ...
              <button onClick={share} className="inline-flex items-center gap-1 hover:text-brand-700"><Share2 size={12} /> Share</button>
            </p>
        ...
        <aside className="lg:col-span-4 space-y-4">
          {related.length > 0 && (
            <div className="card p-5">
              <p className="font-semibold text-ink-900">Related tours</p>
          ...
          <div className="card p-5 bg-brand-50 border-brand-200">
            <p className="font-display text-lg font-semibold text-ink-900">Plan your trip</p>
            <p className="mt-1 text-sm text-ink-500">Tell us where, when, and how you like to travel.</p>
            <Link to="/contact?type=custom" className="btn-primary mt-3 w-full">Start planning</Link>
          </div>
        </aside>
      </div>
    </article>
