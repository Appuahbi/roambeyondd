  ...
  return (
    <div className="bg-cream-gradient min-h-screen">
      <div className="section py-12 text-center max-w-2xl mx-auto">
        <p className="eyebrow justify-center">Where to go</p>
        <h1 className="mt-2 font-display text-4xl sm:text-5xl font-semibold tracking-tight text-ink-900">Destinations across India</h1>
        <p className="mt-2.5 text-ink-500">Beaches, mountains, deserts, backwaters — every kind of trip in one place.</p>
      ...
      <div className="section pb-16" ref={ref}>
        {filtered.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="mt-4 text-ink-500">No matching destinations.</p>
          </div>
        ) : (
